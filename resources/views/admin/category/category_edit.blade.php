...
@section('content')
    <div class="container px-6 mx-auto">
        <div class="px-4 py-3 mb-8 mt-8 bg-white rounded-lg shadow-md dark:bg-gray-800 flex flex-col my-2">
            ...
            <form action="{{ route('admin.CategoryUpdate', ['category' => $category->id]) }}" method="POST">
                @csrf
                @method('put')
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block text-sm">
                            ...
                            <input
                                ...
                                name="category_name" value="{{ $category->category_name }}" placeholder="enter category name..." />
                        </label>
                    </div>
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="description" value="{{ $category->description }}" placeholder="enter category description..." />
                        </label>
                    </div>
                </div>
