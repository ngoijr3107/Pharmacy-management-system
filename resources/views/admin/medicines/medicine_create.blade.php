                ...
                <div class="-mx-3 md:flex mb-6">
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block text-sm">
                            ...
                            <input
                                ...
                                name="name" placeholder="enter medicine name..." />
                        </label>
                    </div>
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block text-sm">
                            ...
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="store_box" placeholder="store box..." />
                        </label>
                    </div>
                </div>
                ...
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="generic_name" placeholder="Generic name..." />
                        </label>
                    </div>
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block text-sm">
                            ...
                            <input type="text"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="effects" placeholder="effects..." />
                        </label>
                    </div>
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block text-sm">
                            ...
                            <input type="date"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="expiry_date" placeholder="Expire date..." />
                        </label>
                    </div>
                </div>
