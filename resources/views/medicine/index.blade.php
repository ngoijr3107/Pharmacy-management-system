...
<div id="content" class="pl-5">
    ...
    @section('content')
        <div class="container">
            <div class="row">
                <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i>
                    Add medicine</button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ url('medicine/create') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="store_box" id="store_box"
